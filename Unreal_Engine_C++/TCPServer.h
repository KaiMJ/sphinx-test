...
private:
	...
	UPROPERTY(Blueprintable, EditAnywhere, Category = "ObjectManager")
	...
	//void CallBlueprintFunction(FJsonObject& JsonData);
	void CallBlueprintFunction(TSharedPtr<FJsonObject>& JsonData);
};